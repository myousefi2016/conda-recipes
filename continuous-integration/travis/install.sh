...
if [ $TRAVIS_OS_NAME == "linux" ]; then sudo apt-get install -yqq git wget build-essential libxt-dev libgl1-mesa-dev \
                                        libxext-dev libpng-dev libimlib2-dev libglew-dev libxrender-dev libxrandr-dev libglm-dev; fi
